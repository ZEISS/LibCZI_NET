# Getting Started
This guide demonstrates how to get started with the "LibCZI_NET" library, including how to open a CZI file, read subblock, attachment, metadata and extract information.
...
With below 3 methods can create streams:
...
After opening a file, you can check for available attachments:
...
You can retrieve a specific attahment by locating its index using its GUID or name:
